gauss_seidel <- function(A, b, x0, max_iter, tol = 0.05) {
  ...
  if(n != nrow(b))  { stop("La dimension del vector d no corresponde") }
...
# Ejemplo con el siguiente sistema
# x - y = 5
# x + 2y = 3
